...
describe('ZwspWordTokenizer', () => {
  ...
  it('string with guillemet', () => {
    const tokenizer = new ZwspWordTokenizer();
    expect(Array.from(tokenizer.tokenize('ឞ្ក្នៃ\u200bរាញា «នារ» ជេសរី'))).toEqual([
      'ឞ្ក្នៃ',
      'រាញា',
      '«',
      'នារ',
  ...
  it('string with punctuation', () => {
    ...
    expect(Array.from(tokenizer.tokenize('ช้าง, ม้า, วัว, กระบือ'))).toEqual([
      'ช้าง',
      ',',
      'ม้า',
      ',',
  ...
  it('string with punctuation inside word', () => {
    const tokenizer = new ZwspWordTokenizer();
    expect(Array.from(tokenizer.tokenize('เริ่ม\u200bต้น\u200bที่ 7,999 บาท'))).toEqual([
      'เริ่ม',
      'ต้น',
      'ที่',
      ' ',
